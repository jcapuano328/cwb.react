        ...
        return (
            <View style={{flex: 1,flexDirection: 'column',justifyContent: 'center',alignItems: 'flex-start',
                ...
                <View style={{flex: 1,flexDirection: 'row',justifyContent: 'flex-start',alignItems: 'center'}}>
                    ...
                    <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center'}}>
                        <Text style={{flex: 1, fontSize: Style.Font.large(),textAlign: 'center',margin: 10}}>{this.props.brigade.name}</Text>
                        <Text style={{flex: 1, fontSize: Style.Font.medium(),textAlign: 'center',margin: 10}}>{this.props.brigade.commander.name}</Text>
                        <Text style={{flex: 1, fontSize: Style.Font.medium(),textAlign: 'center',margin: 10}}>{this.props.brigade.moraleLevel}</Text>
